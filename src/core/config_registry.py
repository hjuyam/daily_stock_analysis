...
_FIELD_DEFINITIONS: Dict[str, Dict[str, Any]] = {
    ...
    "BOLL_PERIODS": {
        "title": "布林带周期",
        "description": "控制计算和展示哪些周期的布林带。仅支持 5/10/20 三个周期，用逗号分隔，例如 \"5,10,20\" 会同时展示三个周期的布林带。仅当 BOLL_ENABLED=true 时生效。每个周期使用 2 倍标准差。",
        "category": "system",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
        ...
        "options": [],
        "validation": {"pattern": r"^(?:5|10|20)(?:,(?:5|10|20))*$", "min_length": 1},
        "display_order": 61,
